  ...
  return (
    <Box width="100%">
      <Box
        ...
        borderRadius={2}
      >
        <Typography variant="overline" color="primary" align="center" width="100%">
          Reporte de ventas por cliente
        </Typography>
      </Box>
      <Box bgcolor="info.main" p={{ xs: 1.5, sm: 2 }} borderRadius={2.5}>
        <Box
          display="flex"
          ...
          mb={2}
        >
          <Box gap={1} display="flex" flexDirection={{ xs: 'column', sm: 'row' }}>
            <DatePicker
